const Search = () =>{
  return (
    <div className="w-full h-full flex justify-center items-center">
      <div className="flex flex-col justify-center items-center p-4 rounded-xl sm:w-[60vw] w-full gap-5">
           
        <div className="flex bg-[#00796b] justify-center flex-col py-5 w-full rounded-md">
          <h4 className="text-2xl sm:text-3xl font-medium mb-5 text-white text-center">
